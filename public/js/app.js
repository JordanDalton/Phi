...
Component.options.__file = "resources/assets/js/components/Contacts/List.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6cb5095a", Component.options)
  } else {
    hotAPI.reload("data-v-6cb5095a", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        update: function update() {
            ...
            axios.put(this.form.urls.update, this.form).then(function (response) {
        ...
        destroy: function destroy(contact) {
            var _this4 = this;
        ...
        showEditForm: function showEditForm(key) {
  ...
  return _c("div", [
    _c("div", { staticClass: "p-4" }, [
      _c(
        ...
        [_vm._v("Contacts (" + _vm._s(_vm.total) + ")")]
      ),
      _vm._v(" "),
      _c(
        "h1",
        ...
        [
          _vm._v(
            _vm._s(
              this.form.type == "create" ? "Add Contact" : "Update Contact"
            )
          )
        ]
      ),
      ...
      _c(
        "a",
        {
          ...
          staticClass: "bg-green text-white mt-8 p-3 rounded no-underline",
          attrs: { href: "#" },
          on: {
            click: function($event) {
              _vm.show.form = true
              _vm.show.table = false
            }
          }
        },
        [_vm._v("Add Contact")]
    ...
    _c(
      "div",
      {
        ...
        staticClass: "bg-green text-white font-bold p-4"
      },
            ...
            [
              _vm.errors
                ? _c("div", { staticClass: "mb-4" }, [
                    _c(
                      "ul",
                      _vm._l(_vm.errors, function(error, field) {
                        return _c("li", { staticClass: "text-red" }, [
                          _vm._v(
                            "\n                    " +
                              _vm._s(error[0]) +
                              "\n                "
              ...
              _c("div", { staticClass: "mb-4" }, [
                ...
                _c("input", {
                  ...
                  staticClass:
                    "shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight",
                  attrs: { id: "city", type: "text", placeholder: "Austin" },
              ...
              _c("div", { staticClass: "mb-4" }, [
                ...
                _c("input", {
                  ...
                  staticClass:
                    "shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight",
                  attrs: { id: "state", type: "text", placeholder: "TX" },
              ...
              _c("div", { staticClass: "mb-4" }, [
                ...
                _c("input", {
                  ...
                  staticClass:
                    "shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight",
                  attrs: { id: "zip", type: "text", placeholder: "76504" },
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.show.table,
            expression: "show.table"
          }
        ],
              ...
              _c(
                ...
                [
                  _c(
                    "a",
                    {
                      staticClass: "bg-red text-white p-2 rounded no-underline",
                      attrs: { href: "#" },
                      on: {
                        click: function($event) {
                          _vm.destroy(contact)
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6cb5095a", module.exports)
  }
}
